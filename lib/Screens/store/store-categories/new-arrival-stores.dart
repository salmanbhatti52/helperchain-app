...
class NewArrivalStores extends StatefulWidget {
  const NewArrivalStores({Key? key}) : super(key: key);

  @override
  State<NewArrivalStores> createState() => _NewArrivalStoresState() ;
}

class _NewArrivalStoresState extends State<NewArrivalStores> with TickerProviderStateMixin{
