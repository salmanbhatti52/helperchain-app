...
import 'bvn-details.dart';

class DataAfterBVN extends StatefulWidget {
  const DataAfterBVN({Key? key}) : super(key: key);

  @override
  State<DataAfterBVN> createState() => _DataAfterBVNState();
}

class _DataAfterBVNState extends State<DataAfterBVN> {
  @override
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  MyElevatedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>const BVNDetails()));
                    },
