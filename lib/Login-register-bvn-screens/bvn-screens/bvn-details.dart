...
class BVNDetails extends StatefulWidget {
  const BVNDetails({Key? key}) : super(key: key);

  @override
  State<BVNDetails> createState() => _BVNDetailsState();
}

class _BVNDetailsState extends State<BVNDetails> {
  @override
